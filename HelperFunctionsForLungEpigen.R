...
load_most_recent_covar <- function(path=paste0(DATA_PATH, "NonCF_updated_sample_sheet_090118.csv")) {
  ...
  targets$RPMM[targets$RPMMClusters=="rLR"] <- "A2";
  targets$RPMM[targets$RPMMClusters=="rRL"] <- "B1";
  targets$RPMM[targets$RPMMClusters=="rRR"] <- "B2";
